		...
		$client->pageListItemBlocks(
			blocks : array(
				...
				$client->pageBlockPhoto(
					photo_id : -3218311624106857876,
					caption : $client->pageCaption(...),
					url : 'https://docs.liveproto.dev',
					webpage_id : 3822288024718726485,
				),
				$client->pageBlockVideo(
					autoplay : true,
					loop : true,
					video_id : -6049966060860138190,
					caption : $client->pageCaption(...),
				),
				...
				$client->pageBlockEmbed(
					...
					url : 'https://docs.liveproto.dev',
					html : 'rX4DMbK5Oz1Lfxk0',
					poster_photo_id : 2625725870991155256,
					w : 39,
					h : 1,
					caption : $client->pageCaption(...),
				),
				$client->pageBlockEmbedPost(
					url : 'https://docs.liveproto.dev',
					webpage_id : 5792871390585129702,
					author_photo_id : 5670952014191458026,
					author : 'iSNp9VqZrYc7f8Mh',
					date : 60,
					blocks : array(
						$client->pageBlockUnsupported(...),
						$client->pageBlockTitle(...),
